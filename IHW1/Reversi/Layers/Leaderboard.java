...
public final class Leaderboard extends Layer implements Renderer.Item
{
    public final static class Record implements Renderer.Item
    {
        ...
        public Record(final int gameID, final Pair<String, Integer> white, final Pair<String, Integer> black) { this.gameID = gameID; this.white = white; this.black = black; }
    ...
    public Leaderboard(final Consumer<Event> eventDispatcher) { super(eventDispatcher); }

    public void add(Record record) { this.records.add(record); }
