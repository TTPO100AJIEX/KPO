...
public final class ConsoleRenderer implements Renderer
{
    private static String parseColor(Colors color)
    {
        ...
        switch (typename)
        {
            case "BOLD":              { answer += "1;3";  break; }
            case "UNDERLINED":        { answer += "4;3";  break; }
            case "BACKGROUND":        { answer += "4";    break; }
            case "BRIGHT":            { answer += "0;9";  break; }
            case "BOLD_BRIGHT":       { answer += "1;9";  break; }
            case "BACKGROUND_BRIGHT": { answer += "0;10"; break; }
            default:                  { answer += "0;3";  break; }
        }
        switch (colorname)
        {
            case "BLACK":  { answer += "0m"; break; }
            case "RED":    { answer += "1m"; break; }
            case "GREEN":  { answer += "2m"; break; }
            case "YELLOW": { answer += "3m"; break; }
            case "BLUE":   { answer += "4m"; break; }
            case "PURPLE": { answer += "5m"; break; }
            case "CYAN":   { answer += "6m"; break; }
            default:       { answer += "7m"; break; }
        }
    ...
    @Override public void render(final Item item)
    {
        if (item == null) return;
    ...
    @Override public void render(final Context context)
    {
