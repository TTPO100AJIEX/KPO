...
import reversi.utils.Renderer.Items.*;

public interface Renderer
{
    public void clear();
    public void render(final Item context);
    ...
    public static final class Context
    {
        ...
        public Context add(final Item item) { this.items.add(item); return this; }

        public Context addText()                                      { return this.add(new Text()); }
        public Context addText(final String text)                     { return this.add(new Text(text)); }
        public Context addText(final String text, final Colors color) { return this.add(new Text(text, color)); }

        public Context addLine()                                      { return this.add(new Line()); }
        public Context addLine(final String text)                     { return this.add(new Line(text)); }
        public Context addLine(final String text, final Colors color) { return this.add(new Line(text, color)); }


        protected ArrayList<Item> getItems() { return this.items; }
        ...
        public Context clear() { this.items.clear(); return this; }
    }
    ...
    public static interface Item
    {
        ...
        public default String getData() { return ""; }
        public default Colors getColor() { return Colors.NONE; }
        public default Context getSubcontext() { return new Context(); }
    }
}
